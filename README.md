...
- [`baseline-results.md`](docs/superpowers/testing/baseline-results.md) — the RED phase: per-scenario verdicts, the captured verbatim rationalizations, and the test-validity caveat.
- [`verify-results.md`](docs/superpowers/testing/verify-results.md) — the GREEN phase: the flips, plus the two-iteration refactor that produced the "example beats rules" lesson.
